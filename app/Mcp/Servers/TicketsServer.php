...
#[Name('Tickets Server')]
#[Version('1.0.0')]
#[Instructions('This server manages tickets and the knowledge base: list and read assigned tickets, create tickets, add notes with slash commands, and search/read/write KB articles. Call get-lookups-tool first for ticket IDs and get-kb-lookups-tool for KB category/tag IDs before creating or updating. Web access requires an Authorization Bearer API token generated at Profile -> Edit Profile -> API Token.')]
class TicketsServer extends Server
{
    ...
    protected array $tools = [
        ...
        PromoteNoteTool::class,
        WatchTicketTool::class,
        GetKbLookupsTool::class,
        KbSearchTool::class,
        GetKbArticleTool::class,
        CreateKbArticleTool::class,
        UpdateKbArticleTool::class,
    ];
