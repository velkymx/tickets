...
@section('content')
<h1>Releases
  <span class="pull-right"><a href="/release/create" class="btn btn-sm btn-primary">Create Release</a></span></h1>
  <hr>
  ...
  <div class="panel-body" align="center">
      ...
      <a href="/release/create" class="btn btn-sm btn-primary">Create A New Release</a>
