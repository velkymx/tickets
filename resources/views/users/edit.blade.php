...
<p class="text-muted">Generate a bearer token to authenticate API requests. <a href="https://github.com/velkymx/tickets/blob/master/README.md" target="_blank">View API documentation</a>.</p>
